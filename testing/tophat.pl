...
my %params = (
    jobName => "tophat-test-2.0.8.4-$$",
    archive => 1,
    #archivePath => "/mkhalfan/API_test/tophat/$cluster\-$$",
    processors => 1,
    requestedTime => '04:00:00',
    #query1 => '/smckay/fastq/WT_rep1.fastq',
    query1 => '/mkhalfan/DNASubway/Mouse_test_1/fx619/fastx_out/pregnant_mouse_2-fx619.fastq.gz',
    genome => '/shared/iplant_DNA_subway/genomes/mus_musculus/genome.fas',
    annotation => '/shared/iplant_DNA_subway/genomes/mus_musculus/annotation.gtf',
